          ...
          <table class="table-auto w-full">
            ...
            <tbody class="text-sm font-medium divide-y divide-gray-100">
              ...
              <tr v-for="i in 10" :key="i">
                ...
                <td class="p-2">
                  <div class="text-center">Engsel Isumi</div>
                </td>
                <td class="p-2">
                  <div class="text-center">Engsel</div>
                </td>
                <td class="p-2">
                  <div class="text-center">Januari</div>
                </td>
                <td class="p-2">
                  <div class="text-center">90</div>
                </td>
                <td class="p-2">
                  <div class="text-center">Mahal</div>
                </td>
                <td class="p-2">
                  <div class="text-center">Habis</div>
                </td>
                <td class="p-2">
