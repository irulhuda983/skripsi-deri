  ...
  <main class="box-border w-full px-4">
    <div class="mt-4 px-4 sm:px-6 lg:px-8 py-8 w-full mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
      <header class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
        ...
        <div>
          <!-- Add view button -->
          <router-link :to="{name: 'listPrediksi'}" class="btn bg-green-500 hover:bg-green-600 text-white">
              <!-- <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                  <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
              </svg> -->
              <span class="hidden xs:block ml-2">List History Prediksi</span>
          </router-link>
        </div>
      </header>
      <div class="p-3">
        ...
        <!-- Table -->
        <div class="overflow-x-auto grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 mb-8">
